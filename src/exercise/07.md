...
It's a bad idea to use array indexes as keys to render an array, because it's
the default behavior of React. It might remove the console error, but it won't
solve the problem. It's better to use a unique identifier.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=07%3A%20Rendering%20Arrays&em=yoh.legrand%40gmail.com).
