...
`console.dir` can print DOM objects as JSON-like tree, while `console.log` will
print a `toString()` representation of the object
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=06%3A%20Forms&em=yoh.legrand%40gmail.com).
