...
With Babel we can gradually move from a simple function returning JSX to a more
conventional "React Component", at the end of the day it all gets compiled down
to `React.createElement` and `ReactDOM.render`.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=yoh.legrand%40gmail.com).
