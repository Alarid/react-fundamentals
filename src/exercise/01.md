...
`append()` can append a set of Nodes OR DOMStrings to the DOM, whereas
`appendChild()` can only append **one** **Node**
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=yoh.legrand%40gmail.com).
